...
description: "Every suite runs in one of two execution modes. Choosing the right one is the most important configuration decision you make when building a suite — it determines whether tests share state, run in ..."
---
