...
This page walks through creating a suite from scratch, adding test cases, configuring execution mode, and running it for the first time.
...
The case is created, added to this suite, and saved to your[ Test Cases library](../../test-management/test-case/about-the-test-cases-library.md) simultaneously — you do not need to create it separately first.
...
[→ Full explanation: Sequential vs. Isolated](sequential-vs.-isolated.md)
