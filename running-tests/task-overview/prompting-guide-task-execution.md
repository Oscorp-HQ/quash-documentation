# Prompting guide (task execution)

A task prompt is a plain English instruction given directly to Mahoraga — the execution agent. Unlike Test Studio prompts that ask Recipe to _generate_ test cases, task prompts are _executed immediately_ on your device. Mahoraga reads your instruction, launches your app, and carries out every step you describe.
...
[→ Test Cases → Suites](../../test-management/test-case/managing-test-cases.md)
