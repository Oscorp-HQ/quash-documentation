...
description: "A task prompt is a plain English instruction given directly to Mahoraga — the execution agent. Unlike Test Studio prompts that ask Recipe to _generate_ test cases, task prompts are _executed immedi..."
---
