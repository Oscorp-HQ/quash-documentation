---
title: "Rerun"
description: "After a successful first run, Mahoraga replays a stored path for speed—unless the UI drifts; then it reasons again and updates what it learned."
---
