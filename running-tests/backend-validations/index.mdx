...
https://www.youtube.com/watch?v=qsvUiM8KU74
...
[→ Setting up a connection ](connections) [→ Creating a validation](creating-a-validation)
...
* [Connections ](connections)— set up your backend connection
* [Creating a validation ](creating-a-validation)— define the API call and assertions
* [Using @slug in prompts ](using-slug-in-prompts)— run validations inline during task execution
