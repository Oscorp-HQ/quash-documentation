...
{% embed url="https://www.youtube.com/watch?v=qsvUiM8KU74" %}
...
[→ Setting up a connection ](connections.md) [→ Creating a validation](creating-a-validation.md)
...
* [Connections ](connections.md)— set up your backend connection
* [Creating a validation ](creating-a-validation.md)— define the API call and assertions
* [Using @slug in prompts ](using-slug-in-prompts.md)— run validations inline during task execution
