...
description: "Once a validation has a prompt action enabled, you can call it inline inside any task prompt by typing `@`. The validation runs at exactly the point in the sequence where you place it — not before,..."
---
