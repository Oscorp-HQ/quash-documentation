---
title: "Using Backend Validations in Prompts"
sidebarTitle: "Using Backend Validations in Prompts"
description: "Trigger prompt-action validations mid-flow: where to place the slug, how runs pause UI work, parameters, and how reports treat optional vs required."
---
...
Every validation that runs during a task appears in the [Execution Report](/execution-reports/report-dashboard) under Observations. The report shows:
