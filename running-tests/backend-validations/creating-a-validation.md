...
A validation is a specific backend check — one API call, with defined expected responses and assertions. You build it on top of a [Connection](connections.md), which handles authentication. The validation itself defines the endpoint, the request details, and what you expect back.
