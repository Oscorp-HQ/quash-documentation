---
title: "Credentials"
description: "The Credentials tab is where you store the login details and authentication tokens the agent uses to access your app during testing. Instead of hardcoding credentials into test prompts or task inst..."
hidden: true
---
