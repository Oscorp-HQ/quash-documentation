---
title: "Using /slug in Prompts"
description: "Once a dataset exists, you reference it in any task or recipe prompt using its slug. The slug is the short identifier you set when creating the dataset — always prefixed with `/`."
---
