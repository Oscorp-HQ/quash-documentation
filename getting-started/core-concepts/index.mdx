---
title: "Core Concepts"
description: "How context compounds in Quash and which core concept page to read before deep Test Studio work."
---
...
Guidance is the knowledge the Megumi agent builds for itself through repeated testing. You do not write it — it accumulates automatically as Mahoraga runs tests on your app. It starts empty and grows every session, mapping screens, learning flows, and recording edge cases. It is also editable, which matters when your app changes between releases.
