...
1. [Quickstart ](quickstart-guide.md)— get your first test running in 5 minutes
2. [Devices ](/broken/pages/MwTC55dV1ZoHsa3DjrhK)— connect a physical device, emulator, or cloud device
3. [Apps ](../apps/adding-an-app.md)— configure your app, upload a build, and connect your codebase
