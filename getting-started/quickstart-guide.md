...
→ See [\[Physical Android Devices\]](../devices/physical-android-devices.md) for the full walkthrough including bounding box calibration.
...
→ See [\[Physical iOS Devices\]](../devices/physical-ios-devices.md) for the full walkthrough including Apple Developer account setup and troubleshooting.
...
→ See [\[iOS Simulators\]](../devices/ios-simulators-mac-only.md) for setup details.
...
Quash cloud devices come with Mahoraga pre-installed. You get 60 minutes of free usage. If all devices are in use, you will be placed in a queue and notified when one becomes available.

→ See [\[Cloud Devices\]](../devices/cloud-device.md) for full details including screen mirroring and parallel testing.
...
For the full walkthrough, see [\[Apps\]](/broken/pages/EKHjBgfBhEorhZSgR7zZ)
...
→ For the complete guide to writing task prompts — including data-driven testing, credential management, and common mistakes — [see Task Prompt Guide.](../running-tests/task-overview/prompting-guide-task-execution.md)
...
* [Writing effective prompts ](../test-studio/prompting-guide-test-generation/writing-effective-prompts.md)— how to structure prompts, use multiple context sources, and refine tests after the first pass
* [Prompt patterns & examples](../test-studio/prompting-guide-test-generation/prompt-patterns-and-examples.md) — five proven templates with worked examples
* [Common mistakes ](../test-studio/prompting-guide-test-generation/common-mistakes.md)— the most frequent prompting errors and a pre-prompt checklist
...
{% embed url="https://www.youtube.com/watch?v=b1jU5EefytY" %}
