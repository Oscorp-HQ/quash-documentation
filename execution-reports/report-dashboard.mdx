...
description: "Every task and suite you run on Quash generates an execution report automatically. As soon as a run finishes, the report is ready — no setup required. The Reports section is where all of these live..."
---
