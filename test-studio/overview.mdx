...
For generation-specific guidance, start with [Prompting Guide (Test Generation)](/test-studio/prompting-guide-test-generation), then use the deeper pages for patterns and common mistakes.
