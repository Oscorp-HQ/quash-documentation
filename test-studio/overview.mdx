---
title: "Overview"
description: "Turn plain-English feature descriptions into structured, runnable test cases without scripts, selectors, or framework setup."
---
...
## Prompting in Test Studio

Test Studio prompting guidance now lives in the central [Prompting Fundamentals](/prompting) section so best practices stay consistent across generation and execution workflows.

For generation-specific guidance, start with [Prompting for Test Generation](/test-studio/prompting-guide-test-generation), then use [Prompt Playbooks](/test-studio/prompting-guide-test-generation/prompt-patterns-and-examples) and [Troubleshooting Prompts](/test-studio/prompting-guide-test-generation/common-mistakes).
